...
NEGATIVE_KEYWORDS = {
    ...
    "LMT": [
        "lockheed martin store",
        "lockheed martin customer service",
        "lockheed martin account",
        "lockheed martin employee",
        "lockheed martin job",
        "lockheed martin career",
        "lockheed martin hiring",
        "lockheed martin office",
        "lockheed martin location",
    ],
    "HON": [
        "honeywell store",
    ...
    "BMY": [
        "bristol myers store",
        "bristol myers customer service",
        "bristol myers account",
        "bristol myers product",
        "bristol myers service",
        "bristol myers support",
        "bristol myers drug",
        "bristol myers medication",
        "bristol myers treatment",
    ],
    "COP": [
        "conocophillips store",
        "conocophillips customer service",
        "conocophillips account",
        "conocophillips employee",
        "conocophillips job",
        "conocophillips career",
        "conocophillips hiring",
        "conocophillips office",
        "conocophillips location",
    ],
    "ISRG": [
        "intuitive surgical store",
        "intuitive surgical customer service",
        "intuitive surgical account",
        "intuitive surgical product",
        "intuitive surgical service",
        "intuitive surgical support",
        "intuitive surgical device",
        "intuitive surgical system",
        "intuitive surgical training",
    ],
    "GILD": [
        "gilead store",
        "gilead customer service",
        "gilead account",
        "gilead product",
        "gilead service",
        "gilead support",
...
class ContextAnalyzer:
    ...
    def analyze_ticker_relevance(
        self, ticker_symbol: str, text: str, matched_terms: list[str]
        ...
        company_name_score = self._check_company_name_presence(
            ticker_symbol, text_lower
        )
        ...
        if len(ticker_symbol) == 1:
            ...
            if confidence < 0.55 and not any(
                "positive_context" in term for term in reasoning_terms
            ):
                confidence = 0.0
