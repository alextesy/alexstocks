...
class StockDataService:
    ...
    async def _fetch_from_finnhub(self, symbol: str) -> Optional[Dict]:
    ...
    async def _fetch_from_twelve_data_simple(self, symbol: str) -> Optional[Dict]:
    ...
    async def get_stock_chart_data(self, symbol: str, period: str = "1mo") -> Optional[Dict]:
        """
    ...
    async def _fetch_historical_finnhub(self, symbol: str, period: str) -> Optional[Dict]:
    ...
    async def _fetch_historical_yahoo(self, symbol: str, period: str) -> Optional[Dict]:
    ...
    async def get_chart_data_for_ui(self, symbol: str, period: str = "1mo") -> Optional[Dict]:
