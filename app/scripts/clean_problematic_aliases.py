...
PROBLEMATIC_ALIASES: set[str] = {
    ...
    'this', 'that', 'with', 'have', 'will', 'your', 'from', 'they', 'know', 'want', 'been', 'good', 'much', 'some', 'time', 'very', 'when', 'come', 'here', 'just', 'like', 'long', 'make', 'many', 'over', 'such', 'take', 'than', 'them', 'well', 'were', 'what', 'year', 'work', 'back', 'call', 'came', 'each', 'even', 'find', 'give', 'hand', 'help', 'keep', 'kind', 'last', 'late', 'left', 'life', 'line', 'live', 'look', 'made', 'move', 'name', 'need', 'next', 'only', 'open', 'part', 'play', 'read', 'right', 'said', 'same', 'seem', 'show', 'side', 'tell', 'turn', 'used', 'week', 'went', 'word', 'able', 'area', 'away', 'ball', 'bank', 'base', 'beat', 'best', 'bill', 'blue', 'book', 'both', 'card', 'care', 'case', 'cash', 'city', 'cold', 'cost', 'data', 'deal', 'deep', 'door', 'down', 'draw', 'drop', 'east', 'easy', 'edge', 'else', 'ever', 'face', 'fact', 'fall', 'fast', 'feel', 'feet', 'fell', 'felt', 'fine', 'fire', 'firm', 'fish', 'five', 'flat', 'flow', 'food', 'foot', 'form', 'four', 'free', 'full', 'game', 'gave', 'girl', 'goal', 'gone', 'grew', 'grow', 'hard', 'head', 'hear', 'heat', 'held', 'high', 'hill', 'hold', 'home', 'hope', 'hour', 'idea', 'kept', 'kill', 'knew', 'land', 'lead', 'less', 'lift', 'link', 'list', 'load', 'loan', 'lock', 'lost', 'love', 'mail', 'main', 'male', 'mark', 'mass', 'mind', 'mine', 'miss', 'must', 'near', 'news', 'nice', 'nine', 'none', 'nose', 'note', 'okay', 'once', 'oral', 'page', 'paid', 'pair', 'park', 'pass', 'past', 'path', 'peak', 'pick', 'plan', 'plus', 'poll', 'poor', 'port', 'post', 'pull', 'push', 'race', 'rail', 'rain', 'rank', 'rate', 'real', 'rear', 'rest', 'rich', 'ride', 'ring', 'rise', 'risk', 'road', 'rock', 'role', 'roll', 'room', 'root', 'rose', 'rule', 'rush', 'safe', 'sake', 'sale', 'salt', 'sand', 'save', 'seat', 'seed', 'seek', 'seen', 'self', 'sell', 'send', 'sent', 'sets', 'ship', 'shop', 'shot', 'shut', 'sick', 'sign', 'silk', 'sing', 'sink', 'site', 'size', 'skin', 'slip', 'slow', 'snap', 'snow', 'soft', 'soil', 'sold', 'sole', 'song', 'soon', 'sort', 'soul', 'soup', 'sour', 'span', 'spin', 'spot', 'star', 'stay', 'step', 'stop', 'suit', 'sure', 'swim', 'tail', 'talk', 'tall', 'tank', 'tape', 'task', 'team', 'tear', 'tend', 'term', 'test', 'text', 'then', 'thin', 'thus', 'till', 'tiny', 'tire', 'told', 'toll', 'tone', 'took', 'tool', 'toss', 'tour', 'town', 'tree', 'trip', 'true', 'tube', 'tune', 'twin', 'type', 'unit', 'upon', 'user', 'uses', 'vary', 'vast', 'view', 'vote', 'wait', 'wake', 'walk', 'wall', 'ward', 'warm', 'warn', 'wash', 'wave', 'ways', 'weak', 'wear', 'west', 'whip', 'wide', 'wife', 'wild', 'wind', 'wine', 'wing', 'wire', 'wise', 'wish', 'wolf', 'wood', 'wore', 'worm', 'worn', 'wrap', 'yard', 'yell', 'zone'
}
