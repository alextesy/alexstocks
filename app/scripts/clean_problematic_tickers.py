...
ENGLISH_STOP_WORDS = {
    ...
    'THIS', 'THESE', 'THOSE', 'WHO', 'WHAT', 'WHERE', 'WHEN',
    ...
    'SHORT', 'HIGH', 'LOW', 'LITTLE', 'FEW', 'SEVERAL', # Action words that could appear in financial context
    ...
    'SELL', 'SELLING', 'BUY', 'BUYING', 'BULL', 'BEAR',
    ...
    'MM', 'CM', 'KM', 'KG', 'LB', 'OZ', 'FT', 'YD', 'MI',
    'MIN', 'AM', 'PM', 'EST', 'PST', 'GMT', 'UTC',
    ...
    'NORTH', 'SOUTH', 'EAST', 'WEST', 'RIGHT', 'CENTER', 'MIDDLE',
    'TOP', 'BOTTOM', 'SIDE', 'CORNER', 'EDGE', 'END', 'BEGIN', # Size and comparison
    ...
    'LINK', 'CLICK', 'BROWSE', 'SEARCH', 'SAVE', 'LOAD', 'DOWNLOAD',
    'UPLOAD', 'LIKE', 'FOLLOW', 'SUBSCRIBE', 'COMMENT', 'POST',
    'EMAIL', 'TEXT', 'MESSAGE', 'CHAT', 'VIDEO', 'PHOTO', 'IMAGE',

    # Emotions and reactions
    'LOVE', 'HATE', 'DISLIKE', 'HAPPY', 'SAD', 'ANGRY', 'MAD',
